...
Core:RegisterCompactTranslations("zhCN", {
  ...
  TAB_HIGHLIGHT_TEXT_COLOR = "激活 / 悬停文字颜色",
  ...
  HOVER_HIGHLIGHT="鼠标悬停高亮", CHAT_TAB_TOOLTIPS="聊天标签提示", TAB_MESSAGE_SEPARATOR="分隔线", TAB_MESSAGE_SPACING="垂直偏移", HEADER_BACKGROUND="标题背景",
  ...
  ABOVE_CHAT="聊天框上方", BELOW_CHAT="聊天框下方", EDIT_BOX_MESSAGE_SEPARATOR="分隔线", MOVEMENT_EASING="移动动画",
  ...
  SHOW_WHILE_TYPING_DESC="聊天输入框打开时重新显示已淡出的聊天消息和标签页。\n默认：开启",
  ...
  MESSAGE_BLACKLIST="消息黑名单", MESSAGE_BLACKLIST_DESC="隐藏包含已屏蔽短语的聊天消息。\n默认：关闭",
  BLOCKED_PHRASES="屏蔽短语", BLOCKED_PHRASES_DESC="每行输入一个纯文本短语。匹配时忽略大小写和重复空白。",
