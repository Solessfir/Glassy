...
local english = {
  ...
  TAB_MESSAGE_SPACING_DESC = "Adds space below the chat tabs while keeping the bottom of the message area fixed.\nDefault: ",
  ...
  LEFT_FADE_DISTANCE = "Left fade percent",
  ...
  RIGHT_FADE_DISTANCE = "Right fade percent",
  ...
  EDIT_MOVEMENT_EASING_DESC = "Controls how messages move when the chat entry field opens or closes.\nDefault: ",
  ...
  SHOW_WHILE_TYPING_DESC = "Reveal faded chat messages and tabs while the chat input is open.\nDefault: on",
  FADING = "Fading",
  ...
  EXPORT_CURRENT_PROFILE = "Export current profile",
  EXPORT_CURRENT_PROFILE_DESC = "Create a copyable string containing only the current profile's settings.",
  PROFILE_STRING = "Profile string",
  PROFILE_STRING_DESC = "Paste a Glassy profile export. The data is validated before it can be imported.",
  NEW_PROFILE_NAME = "New profile name",
  NEW_PROFILE_NAME_DESC = "Enter a unique name for the imported profile.",
  IMPORT_AS_NEW = "Import as new",
  IMPORT_AS_NEW_DESC = "Create and select a new profile using the imported settings.",
  REPLACE_CURRENT = "Replace current",
  REPLACE_CURRENT_DESC = "Replace the current profile with the imported settings.",
  EXPORT_FAILED = "Could not export the current profile.",
  INVALID_PROFILE_STRING = "Invalid Glassy profile string.",
  ENTER_PROFILE_NAME = "Enter a profile name.",
  PROFILE_ALREADY_EXISTS = "A profile with that name already exists.",
  PROFILE_IMPORTED = "Imported profile: %s",
  REPLACE_PROFILE_CONFIRM = "Replace profile '%s'? Its current settings will be lost.",
  EXPORT_PROFILE_TITLE = "Glassy: Export profile",
  HISTORY = "History",
